...
export async function initNativeAlerts(opts?: {
  ...
  try {
    ...
    // Canal v2: o antigo "tips3x3-enter" + sound:"default" apontava para
    // raw/default inexistente e ficava mudo para sempre (canais Android imutáveis).
    // Sem sound → usa o som padrão do sistema; Auto Lay FGS usa alarme nativo.
    await LocalNotifications.createChannel({
      id: "tips3x3-enter-v2",
      name: "Entrada ENTRAR",
      description: "Sinal de entrada Lay (tela ligada / app aberto)",
      importance: 5,
      visibility: 1,
      vibration: true,
    });
      ...
      notifications: [
        {
          ...
          // allowWhileIdle: Doze / tela off (Android 12+)
