...
export function detectShocksAndCorrections(
  ...
  for (const shock of shocks) {
    ...
    // A fase "correcting" já exige recuperação a partir do fundo; exigir slope
    // estritamente positivo reprovava correções momentaneamente planas (as odds
    // andam em ticks discretos), contradizendo o próprio rótulo "Corrigindo ↑".
